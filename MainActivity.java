...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.contain, fragment_babyCenterR);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_babymall) {


        } else if (id == R.id.nav_mymoney) {

        } else if (id == R.id.nav_centerrecord) {
            Fragment_BabyCenterR fragment_babyCenterR=Fragment_BabyCenterR.newInstance("","");
            fragmentTransaction=fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.contain, fragment_babyCenterR);
            fragmentTransaction.commit();
        } else if (id == R.id.nav_takegroup) {
        ...
        } else if (id == R.id.nav_babycenter) {
